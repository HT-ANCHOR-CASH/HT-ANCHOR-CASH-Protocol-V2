...
contract Treasury is ContractGuard, Epoch, Orchestrator {
    ...
    constructor(
        ...
        cashPriceBurn = uint256(90).mul(cashPriceOne).div(10**2);
        ...
        checkOperator
    {
        ...
        uint256 seigniorage = (cashSupply.mul(percentage).div(1e18)).mul(20).div(100);
        ...
        if (IERC20(bond).totalSupply() > accumulatedSeigniorage){
        ...
        if (treasuryReserve > 0) {
            treasuryReserve = seigniorage.mul(40).div(100);
